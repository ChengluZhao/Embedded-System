...
void LED_water(int mode)
{
	...
	switch(mode)
	{
		case 1:
		{
			LED_SET(1,true);delay_ms(1000);LED_SET(1,false);
			LED_SET(2,true);delay_ms(1000);LED_SET(2,false);
			LED_SET(3,true);delay_ms(1000);LED_SET(3,false);
			LED_SET(4,true);delay_ms(1000);LED_SET(4,false);
			LED_SET(5,true);delay_ms(1000);LED_SET(5,false);
			LED_SET(6,true);delay_ms(1000);LED_SET(6,false);
			LED_SET(7,true);delay_ms(1000);LED_SET(7,false);
			LED_SET(8,true);delay_ms(1000);LED_SET(8,false);
			break;
		}
		case 2:
		{
		...
		case 3:
		{
			LED_SET(1,true);delay_ms(500);
			LED_SET(3,true);delay_ms(500);
			LED_SET(5,true);delay_ms(500);
			LED_SET(7,true);delay_ms(500);
			LED_SET(2,true);delay_ms(500);
			LED_SET(4,true);delay_ms(500);
			LED_SET(6,true);delay_ms(500);
			LED_SET(8,true);delay_ms(500);
			break;
		}
		case 4:
		{
			LED_SET(1,true);delay_ms(500);LED_SET(1,false);
			LED_SET(2,true);delay_ms(500);LED_SET(2,false);
			LED_SET(3,true);delay_ms(500);LED_SET(3,false);
			LED_SET(4,true);delay_ms(500);LED_SET(4,false);
			LED_SET(5,true);delay_ms(500);LED_SET(5,false);
			LED_SET(6,true);delay_ms(500);LED_SET(6,false);
			LED_SET(7,true);delay_ms(500);LED_SET(7,false);
			LED_SET(8,true);delay_ms(500);LED_SET(8,false);
			break;
		}
		case 5:
		{
