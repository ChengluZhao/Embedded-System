...
void LED_SET(int led_num,bool led_state)
{
	switch(led_num)
	{
		case 1:
		{
			if(led_state==false)				GPIO_SetBits(GPIOA,GPIO_Pin_2);
			else				GPIO_ResetBits(GPIOA,GPIO_Pin_2);
			break;
		}
		case 2:
		{
			if(led_state==false)				GPIO_SetBits(GPIOC,GPIO_Pin_2);
			else			GPIO_ResetBits(GPIOC,GPIO_Pin_2);
			break;
		}
		case 3:
		{
			if(led_state==false)				GPIO_SetBits(GPIOA,GPIO_Pin_4);
			else				GPIO_ResetBits(GPIOA,GPIO_Pin_4);
			break;
		}
		case 4:
		{
			if(led_state==false)				GPIO_SetBits(GPIOA,GPIO_Pin_7);
			else				GPIO_ResetBits(GPIOA,GPIO_Pin_7);
			break;
		}
		case 5:
		{
			if(led_state==false)				GPIO_SetBits(GPIOC,GPIO_Pin_3);
			else				GPIO_ResetBits(GPIOC,GPIO_Pin_3);
			break;
		}
		case 6:
		{
			if(led_state==false)				GPIO_SetBits(GPIOA,GPIO_Pin_3);
			else				GPIO_ResetBits(GPIOA,GPIO_Pin_3);
			break;
		}
		case 7:
		{
			if(led_state==false)				GPIO_SetBits(GPIOA,GPIO_Pin_5);
			else			GPIO_ResetBits(GPIOA,GPIO_Pin_5);
			break;
		}
		case 8:
		{
			if(led_state==false)			GPIO_SetBits(GPIOC,GPIO_Pin_4);
...
void LED_Tick(u8 key_state)
{
	...
	{
		case 1:
			LED_SET(1,true);LED_SET(2,true);LED_SET(3,true);LED_SET(4,true);
		  LED_SET(5,true);LED_SET(6,true);LED_SET(7,true);LED_SET(8,true);
			break;
		case 2:
			if(led_count==45)
			{
			...
			if(led_count%5==0)
			{
				LED_SET(1,false);LED_SET(2,false);LED_SET(3,false);LED_SET(4,false);
				LED_SET(5,false);LED_SET(6,false);LED_SET(7,false);LED_SET(8,false);
		...
		case 3:
			...
			switch(led_count)
			{	
				case 0:LED_SET(1,false);LED_SET(2,false);LED_SET(3,false);LED_SET(4,false);
							 LED_SET(5,false);LED_SET(6,false);LED_SET(7,false);LED_SET(8,false);break;
				case 5:LED_SET(1,true);LED_SET(2,true);LED_SET(3,true);LED_SET(4,true);
				       LED_SET(5,true);LED_SET(6,true);LED_SET(7,true);LED_SET(8,true);break;
			}break;
